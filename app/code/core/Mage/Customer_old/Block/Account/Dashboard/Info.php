...
class Mage_Customer_Block_Account_Dashboard_Info extends Mage_Core_Block_Template
{
    ...
    public function getOtherInformationUrl()
    {
        return Mage::getUrl('*/account/edit/otherinformation/1');
    }
    public function getProductOfInterestUrl()
    {
        return Mage::getUrl('*/account/edit/productofinterest/1');
    }
    /**
