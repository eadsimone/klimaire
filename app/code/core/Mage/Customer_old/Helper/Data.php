...
class Mage_Customer_Helper_Data extends Mage_Core_Helper_Abstract
{
    ...
    public function getKlimareProductOfInterest()
    {
        $_productOfInterestOption = array(
            'ductless-split-systems'=>array(
                    '1-1'   => 'Multi-Split',
                    '1-2'   => 'Mini-Split',
                    '1-3'   => 'Mini VRF'
                ),
            'package-terminal-systems'  => array(
                    '2-1'   => 'PTAC',
                    '2-2'   => 'PTHP'
                ),
            'indoor-air-quality'    => array(
                    '3-1'   => 'Air Cleaners',
                    '3-2'   => 'Dehudimification Systems',
                    '3-3'   => 'Energy Recovery Units ER',
                    '3-4'   => 'Heat Recovery Units HR'
                ),
            'central-heating-cooling'   => array(
                    '4-1'   => 'Air Conditioners',
                    '4-2'   => 'Commercial VRF Systems',
                    '4-3'   => 'Cooling Coils',
                    '4-4'   => 'Gas Furnace',
                    '4-5'   => 'Heat Pumps',
                    '4-6'   => 'Package Air Conditioner',
                    '4-7'   => 'Package Gas/Electric',
                    '4-8'   => 'Package Heat Pump',
                    '4-9'   => 'Package Water Source'
                )
        );
        return $_productOfInterestOption;
    }
    
    public function getMaxwellProductOfInterest()
    {
        return  array(
            1     => 'Air Curtains',
            2     => 'Boilers & Heaters',
    ...
    public function getServiceType()
    {
        return array(
            ...
            'both'          => 'Both (Installation & Service)'
        );
    }
}
