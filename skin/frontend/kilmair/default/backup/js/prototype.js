...
Element.Methods = {
  ...
  writeAttribute: function(element, name, value) {
    ...
    /* PXP207:Fix "Sort By" dropdown display in IE8:12/17/2010:Hai
       (Upgrading to Prototype 1.7 would also fix this but might affect something else.)  
       Solution by user "Chris Hawkins" in discussion
       https://prototype.lighthouseapp.com/projects/8886/tickets/529-element-constructor-doesnt-add-classname-in-ie8
       "Here is a solution that addresses all three cases of name value pairs and does not rely on sniffing to get the
       version number. It should be inserted at line 1818 (at the end of the for loop in writeAttribute). Basically, it
       just checks to see if the set or remove attribute was successful and tries again with 'class' if it was not."
    */
